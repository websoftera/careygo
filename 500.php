...
<head>
    ...
    <title>Server Error — Careygo</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .err-icon { font-size: 48px; color: #ef4444; margin-bottom: 16px; }
        ...
        .err-ref { font-size: 11px; color: #9ca3af; margin-top: 24px; }
    </style>
</head>
<body>
    <div class="err-card">
        ...
        <p class="err-msg">
            Our server encountered an unexpected error and could not complete your request.<br>
        ...
        <p class="err-ref">Error ID: <?= strtoupper(substr(bin2hex(random_bytes(4)), 0, 8)) ?></p>
    </div>
</body>
</html>
