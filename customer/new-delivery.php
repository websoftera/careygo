...
<head>
    ...
    <title>New Delivery — Careygo</title>
...
<aside class="cust-sidebar" id="custSidebar">
    ...
    <nav class="cust-nav">
        <ul>
            ...
            <li><a href="new-delivery.php" class="cust-nav-link active"><i class="bi bi-plus-circle"></i> New Delivery</a></li>
...
<div class="cust-content-wrap">
    <header class="cust-topbar">
        ...
        <div class="cust-topbar-title">New Delivery</div>
                        ...
                        <div class="booking-success">
                            ...
                            <div class="d-flex gap-3 justify-content-center flex-wrap mt-2">
                                <a href="dashboard.php" class="btn-new-delivery">
                                    <i class="bi bi-grid-1x2 me-1"></i> View All Deliveries
                                </a>
                                <a href="new-delivery.php" class="btn-outline-admin">
